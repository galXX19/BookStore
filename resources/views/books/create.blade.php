<x-layout>
    <x-card class="p-10 max-w-lg mx-auto mt-24">
      <header class="text-center">
        <h2 class="text-2xl font-bold uppercase mb-1">Create a Book entry</h2>
      </header>
      ...
      <form method="POST" action="/books" enctype="multipart/form-data">
        ...
        <div class="mb-6">
          ...
          <input type="text" class="border border-black-200 rounded p-2 w-full" name="tags"
            placeholder="Example: Genre or  Year" value="{{old('tags')}}" />
        ...
        <div class="mb-6">
          ...
          <a href="/" class="text-green ml-4"> Back </a>
        </div>
      </form>
    </x-card>
</x-layout>